    ...
    <>
      ...
      >
        <div className="w-full h-full flex flex-col items-center justify-center gap-8 bg-black bg-opacity-50">
          <h1 className="text-white font-semibold text-2xl  md:text-6xl text-center">
          ...
          <p className="w-[40%] text-white text-center text-wrap">
            Lorem ipsum dolor sit amet, consectetur adipisicing elit.Sed sit amet rcur nunc. Duis egestas ac ante sed tincidunt.
          </p>
